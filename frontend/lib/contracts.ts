...
export const CONFIDENTIAL_TOKEN_ABI = [
  ...
  // Transfer confidential tokens to a contract and trigger its receiver callback
  {
    inputs: [
...
export const BUG_BOUNTY_PROGRAM_ABI = [
  ...
  },
  {
    inputs: [
      ...
      { name: 'inImpactType', type: 'bytes32' },
      { name: 'inSeverity', type: 'bytes32' },
      { name: 'inputProof', type: 'bytes' },
  ...
  },
  {
    inputs: [
      ...
      { name: 'encBountyAmount', type: 'bytes32' },
      { name: 'severity', type: 'uint8' },
      { name: 'inputProof', type: 'bytes' },
      { name: 'encryptedNotes', type: 'bytes' },
      { name: 'plainBountyAmount', type: 'uint256' },
    ],
    name: 'approveReport',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [{ name: 'submissionId', type: 'bytes32' }],
    name: 'getSubmissionMeta',
    outputs: [
      { name: 'submittedAt', type: 'uint256' },
      { name: 'status', type: 'uint8' },
      { name: 'autoEscalated', type: 'bool' },
